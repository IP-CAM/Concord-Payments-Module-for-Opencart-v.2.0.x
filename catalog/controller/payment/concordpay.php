...
class ControllerPaymentConcordpay extends Controller
{
    ...
    public function index()
    {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/concordpay.tpl')) {
            return $this->load->view($this->config->get('config_template') . '/template/payment/concordpay.tpl', $data);
        } else {
            return $this->load->view('default/template/payment/concordpay.tpl', $data);
        }
    }
